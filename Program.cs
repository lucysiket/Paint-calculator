...
namespace Paint_calculator
{
    ...
    {
        // Note: this solution makes the assumption that the room has a rectangular shape, and that 1 litre of paint covers 6 metres of area
        ...
        static double paintRequired(double roomHeight, double roomWidth, double roomLength)
        {
            ...
            return wallArea * (0.17); // Assumes that 1 litre covers 6 metres - so 1 metre requires 1/6 litres (approx 0.17)
        }
